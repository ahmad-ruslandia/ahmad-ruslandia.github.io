...
import sandvikLarge from 'assets/sandvik1-large.jpg';
import sandvikPlaceholder from 'assets/sandvik1-placeholder.jpg';
import sandvik from 'assets/sandvik1.jpg';
...
export const Home = () => {
  ...
  return (
    <div className={styles.home}>
      <Meta
        title="Developer"
        description="Developer portfolio of Ahmad Ruslandia Papua — a product development working on web & mobile
      ...
      <ProjectSummary
        ...
        model={{
          ...
          textures: [
            {
              srcSet: [sandvik, sandvikLarge],
              placeholder: sandvikPlaceholder,
            },
          ],
        }}
      />
      <ProjectSummary
        ...
        model={{
          type: 'phone',
          alt: 'Upload Single Image to Rest API',
          textures: [
            {
